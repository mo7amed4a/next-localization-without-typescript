...
<html>
  ...
  <body>
    ...
    <script>
      var locateDetector = new window.i18nextBrowserLanguageDetector()
      var locate = locateDetector.detect()
      if (locate.indexOf('it') === 0) window.location.href = '/it/'
      else if (locate.indexOf('de') === 0) window.location.href = '/de/'
